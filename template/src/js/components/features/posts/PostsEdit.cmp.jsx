...
import PostForm, { formName } from './PostForm.cmp.jsx';
...
class PostEditCmp extends Component {
	...
	handleSubmit(formValues) {
		let operation = this.state.editMode ? this.props.updatePost : this.props.createPosts;
...
const mapDispatchToPros = dispatch => ({
	createPosts: ({ title, content }) => dispatch(createPosts({ title, content })),
